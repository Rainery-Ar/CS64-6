...
def apply_lora(model, r=2, alpha=8, dropout=0.1):
    """
    Recursively replace nn.Linear layers in the model with LoRA-enabled Linear.
    Keeps pretrained weights, adds LoRA adapters (rank=r).
    """
...
def main():
    ...
    # 3) Load pretrained model with classification head
...
if __name__ == "__main__":
    main()
#training time:Total training time: 393.08 sec (6.55 min)
