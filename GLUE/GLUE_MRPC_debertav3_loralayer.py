...
def main():
    ...
    # 6) Metrics (MRPC uses accuracy + F1 normally, but we can keep accuracy only)
    ...
    training_args = TrainingArguments(
        ...
        num_train_epochs=1,  # MRPC is small → can train for more epochs
        weight_decay=0.01,
        logging_dir="./logs",
        logging_steps=50,
        fp16=use_fp16,
