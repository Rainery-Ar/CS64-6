...
from loralayer import Linear, Embedding  # your LoRA Linear
...
def collate_batch(batch):
    ...
    for example in batch:
        texts.append(encode(example["text"]))
...
# -------------------------------
# 6. Transformer with LoRA applied to all linear layers
# -------------------------------
class LoRATransformerClassifier(nn.Module):
    def __init__(self, vocab_size, embed_dim=128, num_heads=4, hidden_dim=256, num_layers=2, num_classes=2,
        ...
        for _ in range(num_layers):
            ...
            # We'll implement Q, K, V, O as separate Linear layers with LoRA
